...
function Prepare() {
    ...
    for (var i = 2000; i < 2013; i++) {
        ...
        $(D).html(i).attr("data-index", i - 2000);
        $("#use-year").append(D);
    }
...
function Render() {
    ...
    $("#resource-ng").css("height", R_NG * 2).css("width", R_NG * 2).css("margin-top", 0 - R_NG).css("margin-left", 0 - R_NG);
    $("#resource-coal").css("height", R_Coal * 2).css("width", R_Coal * 2).css("margin-top", 0 - R_Coal).css("margin-left", 0 - R_Coal);

    $("#resource-ng-amount").css("top", $(window).outerHeight() * 0.3 + R_NG).html(Consumption_NG);
    ...
    $("#pollution-ch4").css("height", R_CH4 * 2).css("width", R_CH4 * 2).css("margin-top", 0 - R_CH4).css("margin-left", 0 - R_CH4);
    $("#pollution-ch4-amount").css("top", $(window).outerHeight() * 0.73 + R_CH4).html((Pollution_CH4 / 1000000).toFixed(2));
    $("#pollution-ch4-percentage").css("width", $(window).width() * 0.70 - $(window).width() * 0.5 - 200 - R_CH4);
    ...
    $("#pollution-co2").css("height", R_CO2 * 2).css("width", R_CO2 * 2).css("margin-top", 0 - R_CO2).css("margin-left", 0 - R_CO2);
    $("#pollution-co2-amount").css("top", $(window).outerHeight() * 0.33 + R_CO2).html((Pollution_CO2 / 1000000).toFixed(2));
    $("#pollution-co2-percentage").css("width", $(window).width() * 0.80 - $(window).width() * 0.5 - 200 - R_CO2);
    ...
    $("#pollution-n2o").css("height", R_N2O * 2).css("width", R_N2O * 2).css("margin-top", 0 - R_N2O).css("margin-left", 0 - R_N2O);
    $("#pollution-n2o-amount").css("top", $(window).outerHeight() * 0.88 + R_N2O).html((Pollution_N2O / 1000000).toFixed(2));
